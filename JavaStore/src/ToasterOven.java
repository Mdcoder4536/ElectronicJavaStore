...
public class ToasterOven extends Appliance{
  ...
  public ToasterOven(double initPrice, int initQuantity, int initWattage, String initColor, String initBrand, int initWidth, boolean initConvection,int initCart){
